...
public class UIJobJsonAnimationPlayer : MonoBehaviour
{
    public UIAnimationType animationType;
    public JobLottieRawImagePlayer lottiePlayer;
    ...
    public int AdjustSize(int frameIndex = -1) 
    {
        ...
        lottiePlayer.lottieAsset = setting.videoClipsSettings[0].jsonFile;
        lottiePlayer.width = setting.videoClipsSettings[0].jsonFile.Size.x;
        lottiePlayer.height = setting.videoClipsSettings[0].jsonFile.Size.y;
        lottiePlayer.GetComponent<RectTransform>().sizeDelta = new Vector2(lottiePlayer.width, lottiePlayer.height);
    ...
    {
        lottiePlayer.uiTarget.color = new Color(1, 1, 1,1);
        lottiePlayer.ForceStop();
        lottiePlayer.lottieAsset = videoClipSettings.jsonFile;
        lottiePlayer.loop = videoClipSettings.isLooping;
    ...
    {
        lottiePlayer.uiTarget.color = new Color(1, 1, 1, 0);
    }
